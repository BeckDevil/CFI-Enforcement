...
def mainProcess():
	if 'TSXCFI_MODE' in os.environ and os.environ['TSXCFI_MODE'] == 'rtm':
		...
		print("Couldn't find the environment variable TSXCFI_MODE.")
		print("Please set it to 'rtm' or 'hle'.")
		exit()
